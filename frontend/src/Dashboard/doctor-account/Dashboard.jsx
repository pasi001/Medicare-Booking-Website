...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (data && data.doctor) {
      console.log('isApproved:', data.doctor.isApproved);
    }
  }, [data]);
  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 mx-auto">
        ...
        {!loading && !error && data && data.doctor && (
                  ...
                  <div>
                    <div className='flex items-center gap-4 mb-10'>
                      ...
                      <div>
                        ...
                        rounded text-[12px] leading-4 lg:text-[16px] leading-6 font-semibold">
                        ...
                        <div className="flex items-center gap-[6px]">
                          ...
                          leading-5 lg:text-[16px] lg:leading-6 font-semibold">
                            ...
                            {data.doctor.averageRating.toFixed(2)}
                          </span>

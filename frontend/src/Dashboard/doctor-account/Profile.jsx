...
const Profile = ({doctorData}) => {
    ...
    const handleFilesInputChange = async event => {
    ...
    <div>
        ...
        <form>
            ...
            <div className="mb-5">
                ...
                {formData.qualifications?.map((item, index) => (
                    <div key={index}>
                        <div>
                            ...
                            <button 
                              onClick={e => deleteQualification(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] 
                ...
                <button onClick={addQualifications} className="bg-[#000] py-2 px-5 rounded 
            ...
            <div className="mb-7">
                <button 
                  ...
                  className="bg-primaryColor text-white text-[18px] leading-[30px] w-full py-3 
                  px-4 rounded-lg">
                    Update Profile
                </button>
            </div>
